...
const About = ({ about }: { about: aboutType | undefined }) => {
  const skillsNames = ["Problem solving", "JavaScript", "APIs", "TypeScript", "React", "React Router", "React Query", "Redux Toolkit", "Zustand", "Next.js", "HTML", "CSS", "SCSS", "GitHub", "Git", "Npm", "Yarn", "Figma", "Microsoft Offce", "Photoshop", "PremierePro", "AfterEffects"]
  ...
  return (
    <section className="about wrapper" id="about">
      ...
      <div className="container rounded wrapper">
        <div className="story">
